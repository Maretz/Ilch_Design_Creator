...
<link href="//maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">
 ...
 <div class="container">
   ...
   <?php
                    ...
                    if(@unlink('uninstall.php') && @unlink('include/admin/designcreator.php') && @unlink('include/boxes/lastnews_creator.php') && @unlink('include/boxes/lastforum_creator.php') && @unlink('include/boxes/login_creator.php') && @unlink('include/boxes/style_creator.php')  && @unlink('include/images/icons/admin/dc.png') && @unlink('include/designs/mar_Creator/index.htm') && @unlink('include/designs/mar_Creator/style.css')  && @unlink('include/designs/mar_Creator/templates/user/boxen_login_creator.htm') && @unlink('include/admin/templates/designcreator.htm') && @unlink('include/includes/js/jquery.minicolors.js') && @unlink('include/includes/css/jquery.minicolors.css')) {
                        ...
                        $erfolg .= '<p class="text-danger">Die Moduldateien konnten nicht automatisch gel&ouml;scht werden.Folgende Dateien sollten entfernt werden:</p><p class="text-danger"><i>uninstall.php</i><br><i>include/admin/designcreator.php</i><br><i>include/admin/templates/designcreator.htm</i><br><i>include/boxes/lastnews_creator.php</i><br><i>include/boxes/lastforum_creator.php</i><br><i>include/boxes/login_creator.php</i><br><i>include/boxes/style_creator.php</i><br><i>include/images/icons/admin/dc.png</i><br><i>include/includes/js/jquery.minicolors.js</i><br><i>include/includes/css/jquery.minicolors.css</i><br><i>Ordner include/designs/mar_Creator</i></p>';
                    }
